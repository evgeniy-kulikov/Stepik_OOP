...
# Task 01
"""
Создайте класс Device, который будет служить базовым классом для всех устройств в доме. 
Класс "Device" должен иметь "slots" для защищенных атрибутов "_name", "_location" и "_status"(по умолчанию ON). 
Для атрибут "_name" создайте свойство только для чтения, 
а для атрибутов "_location" и "_status" - свойства для чтения и записи. 
Добавьте метод "turn_on" для изменения статуса устройства на "ON" и метод "turn_off" для изменения статуса на "OFF".
 
Создайте класс Light, который будет наследоваться от класса "Device" и представлять устройства освещения. 
...
Создайте класс Thermostat, который будет наследоваться от класса "Device" 
...
Создайте класс SmartTV, который будет наследоваться от класса "Device" 
